...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "inventory_service"),
        "USER": os.getenv("DB_USER", "inventory_service"),
        "PASSWORD": os.getenv("DB_PASSWORD", "inventory_service_password"),
        "HOST": os.getenv("DB_HOST", "inventory_service_db"),
